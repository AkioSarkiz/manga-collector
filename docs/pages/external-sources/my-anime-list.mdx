...
```typescript
import { ExternalSourceContext, MyAnimeListStrategy, ScrapedDetailedManga } from "@akiosarkiz/manga-collector";
...
const strategy = new MyAnimeListStrategy(detailedManga);
